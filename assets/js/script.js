jQuery(document).ready(function($) {  
  ...
  $('.owl-carousel2').owlCarousel({
      ...
      margin:10,
      nav:false,
      navText: ["<img src='http://wpfolder/wp-content/themes/prengi.wp/assets/icons/left_arrow.png'>","<img src='http://wpfolder/wp-content/themes/prengi.wp/assets/icons/right_arrow.png'>"],
      items:1,
      dots: true,
      responsive:{
        576:{
